...
<body>
    ...
    <div class="login">
      <div class="box">
        <div class="form-box" style="overflow: hidden">
          ...
          <form class="input-group" id="register" style="left: 450px">
  ...
  switch ($_POST['user_type']) {
    case 'STUDENT':
      $query = "SELECT * FROM student_view WHERE student_id = '$id' && student_password = '$password'";
      break;
    case 'FACULTY':
      $query = "SELECT * FROM faculty_view WHERE faculty_id = '$id' && faculty_password = '$password'";
      break;
    case 'ADMIN':
